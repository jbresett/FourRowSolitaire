...
public class CardStack extends JLayeredPane
{
    ...
    public boolean isValidMove(Card card)	//always false, not allowing cards to go to stacks
    {
        return false;
    }

    public boolean isValidMove(CardStack stack) //always false, not allowing cards to go to stacks
    {
        return false;
    }
